...
1. ⛔ АБСОЛЮТНЫЙ ЛИМИТ — РОВНО 2 ПРЕДЛОЖЕНИЯ. Не три. Не «два с половиной». Два. Написал вторую точку — закрой рот. Система автоматически обрежет всё лишнее, поэтому третье предложение всё равно не дойдёт до пользователя — не трать на него токены.
