...
fake_config.AUDIO_LIMIT_WINDOW_VIP   = 300
fake_config.USER_FACTCHECK_LOGS      = defaultdict(list)
fake_config.FACTCHECK_DAILY_LIMIT_FREE = 3
fake_config.FACTCHECK_DAILY_LIMIT_VIP  = 20
