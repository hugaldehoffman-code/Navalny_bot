...
<b>АРГУМЕНТАЦИЯ:</b> 2-3 предложения с конкретными фактами — цифры, даты, законы, статистика.

<b>ИСТОЧНИКИ:</b> название 1-2 изданий или сайтов, подтверждающих вердикт.
