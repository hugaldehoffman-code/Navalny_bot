...
class LimitsMiddleware(BaseMiddleware):
    ...
    async def _send_limit_exceeded(
        ...
        builder.button(text="⭐ VIP Lite — 299 ⭐ (30 дней)", callback_data="buy_vip_lite_30")
        builder.button(text="👑 VIP Pro — 599 ⭐ (30 дней)", callback_data="buy_vip_pro_30")
        ...
        msg = (
            ...
            f"⭐ <b>VIP Lite</b> — 299 ⭐ / 30 дней (до 100 текстовых и 20 медиа)\n"
            f"👑 <b>VIP Pro</b> — 599 ⭐ / 30 дней (безлимит + анализ документов)\n\n"
