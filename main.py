...
from PIL import Image, ImageDraw, ImageFont  # Добавили импорты из Pillow для работы с графикой
...
- Коллеги: Добрая ухмылка над Певчих, Волковым, Ждановым. Подкалывай их за то, что они сидят в безопасном Лондоне, рисуют графики в Твиттере и продают худи, пока ты тут.
- Бэкграунд: Кировлес, Ив Роше, выборы 2013, синие трусы, Шарите. Вспоминай об этом вскользь, как о старых забавных приключениях, без пафоса мученика.
"""
...
async def photo_handler(message: Message):
    ...
    await process_ai_reply(message, system_addition=BUTTON_PROMPTS["vision_comment"], trigger_text=caption)
